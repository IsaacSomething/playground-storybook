  ...
  template: `
    <mat-card [attr.color]="color">
      ...
      <mat-card-content class="margin-top">
        Eligendi, provident dolores mollitia inventore facilis harum dolore nam
        in ut! Eveniet reiciendis, laudantium excepturi velit cum totam quo
        expedita aspernatur tenetur?
      </mat-card-content>
